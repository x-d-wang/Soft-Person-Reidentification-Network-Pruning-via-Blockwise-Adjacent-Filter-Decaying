...
parser.add_argument('--data_dir',default='./datasets/Market/pytorch',type=str, help='training dir path')
...
parser.add_argument('--prune_rate',default=0.1,type=float, help='prune rate for SFP')
...
copyfile('./SFP_train.py', dir_name+'/SFP_train.py')
copyfile('./scripts/SFP_train.sh', dir_name+'/SFP_train.sh')
